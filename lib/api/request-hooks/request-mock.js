...
var RequestMock = function (_RequestHook) {
    ...
    RequestMock.prototype.respond = function respond(body, statusCode, headers) {
        ...
        var mock = new _prodperfectTestcafeHammerhead.ResponseMock(body, statusCode, headers);
        var rule = new _prodperfectTestcafeHammerhead.RequestFilterRule(this.pendingRequestFilterRuleInit);
